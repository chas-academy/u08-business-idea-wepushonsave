      ...
      <div className="flex flex-col items-center">
         ...
         {threads.map(thread => (
            <div key={thread.id} className="w-full max-w-lg mb-4 bg-blue-200">
               <h2
                  className="text-2xl font-bold cursor-pointer bg-blue-300"
                  ...
                  <div>
                     ...
                     {thread.comments.slice(2).map(comment => (
                        <div
                           ...
                           style={{ display: thread.collapsed ? 'none' : 'block' }}>
                           <p className="text-gray-700">{comment.text}</p>
                        </div>
                     ))}
               ...
               <form
                  onSubmit={e =>
                     handleCommentSubmit(e, thread.id, e.currentTarget.comment.value)
                  }
                  className="mt-2">
                  <input
                     type="text"
